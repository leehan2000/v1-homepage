          ...
          <div className="max-w-3xl text-left">
            ...
            >
              ...
              <Button 
                ...
                className="border-2 border-white/40 text-white bg-black/30 backdrop-blur-sm hover:bg-black/50 shadow-lg px-6 md:px-8 py-6 text-base md:text-lg font-semibold w-full sm:w-auto"
              >
                서비스 구성 살펴보기
              </Button>
            </div>
