...
const UplusMobileInternet = () => {
  ...
  // 업종/사용처 데이터
  const industryItems = [
    { imageKey: "industry1", title: "건설업", desc: "공사현장, 임시 컨테이너 근무" },
    { imageKey: "industry2", title: "광고·미디어", desc: "디지털 광고판, 키오스크 원격 관리" },
    { imageKey: "industry3", title: "유통업", desc: "자판기, 포스, 키오스크 결제" },
    { imageKey: "industry4", title: "제조업", desc: "장치, 배터리 원격 관리, 데이터 수집" },
    { imageKey: "industry5", title: "서비스·금융", desc: "외근, 출장, 이동 중 업무" },
    { imageKey: "industry6", title: "IT", desc: "임시 사무실 등 단기간 업무" },
    { imageKey: "industry7", title: "태양광", desc: "발전량 원격 모니터링" },
    { imageKey: "industry8", title: "농막", desc: "CCTV 운영, 관리" },
    { imageKey: "industry9", title: "캠핑", desc: "캠핑장, 캠핑카 내 영화, 유튜브" },
    { imageKey: "industry10", title: "차량", desc: "네비게이션 연결, 패드/노트북 작업" },
    { imageKey: "industry11", title: "기숙사", desc: "노트북 강의 시청, 태블릿 작업" },
    { imageKey: "industry12", title: "주택/가정집", desc: "부모님댁 CCTV, 휴대폰 와이파이 연결" },
  ];
  ...
  return (
    <>
      ...
      >
        ...
        {/* 텍스트 컨텐츠 */}
        <div className="relative z-10 container mx-auto px-4 md:px-6 max-w-7xl w-full py-12 md:py-16 pb-24">
          <div className="max-w-xl md:max-w-2xl text-center md:text-left">
            {/* 상단 라벨 */}
            <div 
              className={`inline-block bg-white/20 backdrop-blur-sm border border-white/30 px-4 py-1.5 md:px-5 md:py-2 rounded-full text-xs md:text-sm font-semibold mb-4 md:mb-6 text-white tracking-wide transition-all duration-500 ease-out motion-reduce:transition-none motion-reduce:transform-none motion-reduce:opacity-100 ${
            ...
            {/* 서브 카피 */}
            <p 
              className={`text-base md:text-lg lg:text-xl mb-6 md:mb-8 text-white/95 leading-relaxed max-w-xl transition-all duration-500 ease-out motion-reduce:transition-none motion-reduce:transform-none motion-reduce:opacity-100 ${
                heroVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-3"
              }`}
      ...
      <section id="advantages" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 
            className={`text-3xl md:text-4xl font-bold text-center mb-4 text-gray-900 transition-all duration-700 ease-out motion-reduce:transition-none motion-reduce:transform-none motion-reduce:opacity-100 ${
              visibleSections.has("advantages") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
            U+모바일인터넷이 정답입니다.
          </h2>
          <p 
            className={`text-center text-lg text-gray-600 mb-12 transition-all duration-700 ease-out motion-reduce:transition-none motion-reduce:transform-none motion-reduce:opacity-100 ${
              visibleSections.has("advantages") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8">
            ...
            {/* 오른쪽: 해결 */}
            <Card 
              className={`rounded-2xl shadow-lg border-2 border-green-100 bg-green-50/30 transition-all duration-700 ease-out motion-reduce:transition-none motion-reduce:transform-none motion-reduce:opacity-100 ${
                visibleSections.has("advantages") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              }`}
              style={{ transitionDelay: "300ms" }}
            >
      ...
      {/* Why U+ 섹션 */}
      <section id="recommended-customers" className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 
            className={`text-3xl md:text-4xl font-bold text-center mb-12 text-gray-900 transition-all duration-700 ease-out motion-reduce:transition-none motion-reduce:transform-none motion-reduce:opacity-100 ${
              visibleSections.has("recommended-customers") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
            왜 U+일까요?
          </h2>
              ...
              >
                <div className="relative h-32 overflow-hidden rounded-t-2xl">
                  {!imageErrors[item.imageKey] ? (
                    <img
                      src={IMG[item.imageKey as keyof typeof IMG]}
                      alt={item.title}
                      className="w-full h-full object-cover group-hover:scale-[1.05] transition-transform duration-300"
      ...
      <section id="service-diagram" className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 
            className={`text-3xl md:text-4xl font-bold text-center mb-4 text-gray-900 transition-all duration-700 ease-out motion-reduce:transition-none motion-reduce:transform-none motion-reduce:opacity-100 ${
              visibleSections.has("service-diagram") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
            서비스 구성도를 살펴보세요.
          </h2>
          ...
          <Card 
            className={`rounded-2xl shadow-lg max-w-4xl mx-auto transition-all duration-700 ease-out motion-reduce:transition-none motion-reduce:transform-none motion-reduce:opacity-100 ${
              visibleSections.has("service-diagram") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
            style={{ transitionDelay: "200ms" }}
          >
      ...
      <section id="devices" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 
            className={`text-3xl md:text-4xl font-bold text-center mb-12 text-gray-900 transition-all duration-700 ease-out motion-reduce:transition-none motion-reduce:transform-none motion-reduce:opacity-100 ${
              visibleSections.has("devices") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
            용도에 맞는 기기를 선택하세요.
          </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-8">
            ...
            >
              <CardContent className="p-6">
                <div className="relative h-48 overflow-hidden rounded-t-2xl mb-4">
                  {!imageErrors.devices ? (
                    <img
                      src={IMG.devices}
                      alt="5G 라우터"
      ...
      {/* 테크 인플루언서 후기 섹션 */}
      <section id="customer-cases" className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 
            className={`text-3xl md:text-4xl font-bold text-center mb-12 text-gray-900 transition-all duration-700 ease-out motion-reduce:transition-none motion-reduce:transform-none motion-reduce:opacity-100 ${
              visibleSections.has("customer-cases") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            ...
            <Card className="rounded-2xl shadow-lg">
              <CardContent className="p-6">
                <div className="relative h-32 overflow-hidden rounded-t-2xl mb-4">
                  {!imageErrors.reviews ? (
                    <img
                      src={IMG.reviews}
                      alt="리뷰"
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            <Card 
              className={`group rounded-2xl border shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 bg-white overflow-hidden cursor-pointer ${
                visibleSections.has("customer-cases") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              }`}
              style={{ transitionDelay: "0ms" }}
            >
              <CardContent className="p-6">
                <div className="relative h-40 overflow-hidden rounded-t-2xl mb-4">
                  {!imageErrors.cases ? (
                    <img
                      src={IMG.cases}
                      alt="고객사례"
      ...
      <section id="pricing" className="py-28 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8 mb-12">
            {/* 요금제 A */}
            <Card 
              className={`rounded-2xl border-2 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 bg-white ${
                visibleSections.has("pricing") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              }`}
              style={{ transitionDelay: "0ms" }}
            >
              <CardContent className="p-6">
                <div className="text-center mb-6">
                  <h3 className="text-2xl font-bold mb-2 text-gray-900">LTE 11GB</h3>
            ...
            {/* 요금제 B */}
            <Card 
              className={`rounded-2xl border-2 border-primary shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 bg-white ${
                visibleSections.has("pricing") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              }`}
              style={{ transitionDelay: "100ms" }}
            >
              <CardContent className="p-6">
                ...
                <div className="text-center mb-6">
                  <h3 className="text-2xl font-bold mb-2 text-gray-900">LTE 60GB</h3>
            ...
            >
              <CardContent className="p-6">
                <div className="text-center mb-6">
                  <h3 className="text-2xl font-bold mb-2 text-gray-900">LTE 100GB</h3>
      ...
      {/* 중간 CTA 섹션 */}
      <section id="middle-cta" className="py-24 bg-primary/5">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 
            className={`text-2xl md:text-3xl font-bold mb-4 text-gray-900 transition-all duration-700 ease-out motion-reduce:transition-none motion-reduce:transform-none motion-reduce:opacity-100 ${
              visibleSections.has("middle-cta") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
            맞춤 요금제가 궁금하신가요?
          </h2>
          <p 
            className={`text-lg text-gray-600 mb-8 transition-all duration-700 ease-out motion-reduce:transition-none motion-reduce:transform-none motion-reduce:opacity-100 ${
              visibleSections.has("middle-cta") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
            style={{ transitionDelay: "100ms" }}
          >
          ...
          <div 
            className={`flex flex-col sm:flex-row gap-4 justify-center transition-all duration-700 ease-out motion-reduce:transition-none motion-reduce:transform-none motion-reduce:opacity-100 ${
              visibleSections.has("middle-cta") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
            style={{ transitionDelay: "200ms" }}
          >
      ...
      {/* 가입/개통 안내 섹션 */}
      <section id="signup-guide" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 
            className={`text-3xl md:text-4xl font-bold text-center mb-12 text-gray-900 transition-all duration-700 ease-out motion-reduce:transition-none motion-reduce:transform-none motion-reduce:opacity-100 ${
              visibleSections.has("signup-guide") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
            가입/개통 절차를 알아보세요.
          </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              <Card 
                key={idx} 
                className={`group rounded-2xl border shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 bg-white overflow-hidden cursor-pointer ${
                  visibleSections.has("insights") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                }`}
      ...
      {/* 추천상품 섹션 */}
      <section id="recommended-products" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 
            className={`text-3xl md:text-4xl font-bold text-center mb-12 text-gray-900 transition-all duration-700 ease-out motion-reduce:transition-none motion-reduce:transform-none motion-reduce:opacity-100 ${
              visibleSections.has("recommended-products") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            ...
            >
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-3 text-gray-900">기업 인터넷전화 센트릭스</h3>
                <p className="text-gray-600 mb-4">
            ...
            >
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-3 text-gray-900">U+커넥트</h3>
                <p className="text-gray-600 mb-4">
            ...
            >
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-3 text-gray-900">U+웍스</h3>
                <p className="text-gray-600 mb-4">
      ...
      <section id="downloads" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 
            className={`text-3xl md:text-4xl font-bold text-center mb-12 text-gray-900 transition-all duration-700 ease-out motion-reduce:transition-none motion-reduce:transform-none motion-reduce:opacity-100 ${
              visibleSections.has("downloads") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
            자료 다운로드
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8 max-w-4xl mx-auto">
            ...
            >
              <div className="relative h-48 overflow-hidden rounded-t-2xl">
                {!imageErrors.download1 ? (
                  <img
                    src={IMG.download1}
                    alt="상품 소개서"
                    className="w-full h-full object-cover group-hover:scale-[1.05] transition-transform duration-300"
                    onError={() => handleImageError("download1")}
                  />
                ) : (
                  <div className="w-full h-full bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center">
              ...
              <CardContent className="p-6">
                <h3 className="font-bold text-lg mb-2 text-gray-900">상품 소개서 다운로드</h3>
            ...
            >
              <div className="relative h-48 overflow-hidden rounded-t-2xl">
                {!imageErrors.download2 ? (
                  <img
                    src={IMG.download2}
                    alt="요금제 안내서"
                    className="w-full h-full object-cover group-hover:scale-[1.05] transition-transform duration-300"
                    onError={() => handleImageError("download2")}
                  />
                ) : (
                  <div className="w-full h-full bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center">
                    <FileText className="w-16 h-16 text-gray-400" />
              ...
              <CardContent className="p-6">
                <h3 className="font-bold text-lg mb-2 text-gray-900">요금제 안내서 다운로드</h3>
                <Button variant="outline" className="w-full mt-4" onClick={() => {}}>
                  다운로드
                </Button>
              </CardContent>
            ...
            >
              <div className="relative h-48 overflow-hidden rounded-t-2xl">
                {!imageErrors.download3 ? (
                  <img
                    src={IMG.download3}
                    alt="가입 서류 안내"
                    className="w-full h-full object-cover group-hover:scale-[1.05] transition-transform duration-300"
                    onError={() => handleImageError("download3")}
                  />
                ) : (
                  <div className="w-full h-full bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center">
                    <FileText className="w-16 h-16 text-gray-400" />
              ...
              <CardContent className="p-6">
                <h3 className="font-bold text-lg mb-2 text-gray-900">가입 서류 안내 다운로드</h3>
                <Button variant="outline" className="w-full mt-4" onClick={() => {}}>
                  다운로드
                </Button>
              </CardContent>
