    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        <img
          ...
          alt="V1 사무실 전경"
          className="w-full h-full object-cover contrast-125 saturate-[1.2] brightness-110 animate-kenburns"
        />
        <Particles
          id="tsparticles"
          ...
          options={{
            ...
            interactivity: {
              events: {
                onHover: { enable: true, mode: "repulse" },  // 마우스 오버 시 반발 효과
                onClick: { enable: true, mode: "push" }      // 클릭 시 입자 추가
              },
              modes: {
                repulse: { distance: 50, speed: 0.5 },
                push:   { quantity: 4 }
              }
            }        
          }}
          ...
          <div className="animate-fadeIn w-full md:max-w-lg lg:max-w-xl md:mt-10 md:ml-8 lg:ml-16">
            <div className="bg-gradient-to-br from-gray-900/70 to-black/60 backdrop-blur-sm p-8 rounded-lg border-l-4 border-lgred shadow-2xl">
              <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-6">
                <span className="text-lgred">신뢰</span>와{" "}
                <span className="text-lgred">전문성</span>을 <br />
                바탕으로 하는
                <br />
                통신 솔루션 전문기업
              ...
              <p className="text-lg md:text-xl text-gray-200 mb-8 leading-relaxed">
                브이원정보통신은 고객의 환경에 최적화된 맞춤형 통신 인프라
                구축을 통해 업무 효율성과 안정성을 제공합니다.
              </p>
      ...
      <div
        ...
        style={{ overflow: "hidden", transform: "translateY(1px)" }}
      >
        <svg
      ...
      <div
        ...
        style={{ overflow: "hidden", transform: "translateY(2px)" }}
      >
        <svg
          className="absolute bottom-0 w-full h-full"
          xmlns="http://www.w3.org/2000/svg"
          ...
          style={{
            width: "300%",
            animation:
              "wave 8s cubic-bezier(0.36, 0.45, 0.63, 0.53) infinite alternate",
            transform: "scale(1.1)",
          }}
        >
          <path
      ...
      {/* 물결 레이어 2 - 파란색 */}
      <div
        className="absolute bottom-0 left-0 w-full h-28 z-20"
        style={{ overflow: "hidden", transform: "translateY(3px)" }}
      >
        <svg
          className="absolute bottom-0 w-full h-full"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <div
        ...
        style={{ overflow: "hidden", transform: "translateY(4px)" }}
      >
        <svg
          className="absolute bottom-0 w-full h-full"
          xmlns="http://www.w3.org/2000/svg"
          ...
          style={{
            width: "300%",
            animation:
              "wave 20s cubic-bezier(0.36, 0.45, 0.63, 0.53) infinite reverse",
          }}
        >
          <path
      ...
      {/* 물결 레이어 4 - 초록색 */}
      <div
        className="absolute bottom-0 left-0 w-full h-22 z-20"
        style={{ overflow: "hidden", transform: "translateY(5px)" }}
      >
        <svg
          className="absolute bottom-0 w-full h-full"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <div
        ...
        style={{ overflow: "hidden", transform: "translateY(6px)" }}
      >
        <svg
          className="absolute bottom-0 w-full h-full"
          xmlns="http://www.w3.org/2000/svg"
          ...
          style={{
            width: "300%",
            animation:
              "wave 22s cubic-bezier(0.36, 0.45, 0.63, 0.53) infinite reverse",
      ...
      <div
        ...
        style={{ overflow: "hidden", transform: "translateY(7px)" }}
      >
        <svg
          className="absolute bottom-0 w-full h-full"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="absolute bottom-24 left-0 w-full text-center text-white/90 text-sm font-light z-30">
        <span className="tracking-widest px-6 py-2 rounded-full bg-gradient-to-r from-blue-800/60 to-lgred/40 backdrop-blur-md border border-white/20 shadow-lg animate-pulse">
          신뢰 위에서, 연결 너머로
        </span>
      </div>
