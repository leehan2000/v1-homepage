              ...
              <NavigationMenuList>
                ...
                <NavigationMenuItem value="contact">
                  ...
                  <NavigationMenuContent>
                    <ul className={subMenuUlStyle}>
                      <li>
                        <NavigationMenuLink asChild className={applySubMenuStyle("/contact/business-phone", isActive("/contact/business-phone"))}>
                          <Link href="/contact/business-phone">기업전화</Link>
                        </NavigationMenuLink>
                      </li>
                      <li>
                      ...
                      <li>
                        <NavigationMenuLink asChild className={applySubMenuStyle("/contact/uplus-vehicle", isActive("/contact/uplus-vehicle"))}>
                          <Link href="/contact/uplus-vehicle">차량관제</Link>
                        </NavigationMenuLink>
                      </li>
                      <li>
                        <NavigationMenuLink asChild className={applySubMenuStyle("/contact/uplus-soho-internet", isActive("/contact/uplus-soho-internet"))}>
                          <Link href="/contact/uplus-soho-internet">소호인터넷</Link>
                        </NavigationMenuLink>
                      </li>
                      <li>
